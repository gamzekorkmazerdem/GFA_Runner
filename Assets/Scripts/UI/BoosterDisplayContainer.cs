...
public class BoosterDisplayContainer : MonoBehaviour
{
    ...
    {
        // instantiate metotu kendisine verilen nesnenin oluþturulup sahneye eklenmesini saðlar
        // oluþturulan nesne ikinci parametredeki nesneye child olarak eklenir
